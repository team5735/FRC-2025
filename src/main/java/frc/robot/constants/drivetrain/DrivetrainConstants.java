...
public class DrivetrainConstants {
    ...
    public static final double SPEED_MPS = 3;
    public static final double ROBOT_MASS_KG = 25.35;
    public static final double MAX_WHEEL_DISTANCE_M = Units.inchesToMeters(25);
    public static final double ROBOT_MOI_KGxMxM = ROBOT_MASS_KG * MAX_WHEEL_DISTANCE_M / 2 * ROTATION_KA
            / CompbotTunerConstants.driveGains.kA; // Formula for approx. MoI
