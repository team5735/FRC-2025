...
public class PathPlannerHelpers{
    /**
     * Creates a path that is a line from the start point to the end point, with the robot ending with
     * zero velocity and facing in the direction of endRobotHeading
     *
